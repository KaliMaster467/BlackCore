...
struct Input;	/* Chat.h:5 */
struct ns__getInfoResponse;	/* Chat.h:10 */
struct ns__getInfo;	/* Chat.h:13 */
...
struct ns__getInfoResponse {
      public:
        /** Optional element 'rec' of XSD type 'xsd:string' */
        char *rec;
      public:
...
struct ns__getInfo {
      public:
        /** Optional element 'msg' of XSD type 'Input' */
        struct Input *msg;
      public:
...
\******************************************************************************/
    ...
    SOAP_FMAC5 int SOAP_FMAC6 ns__getInfo(struct soap*, struct Input *msg, struct ns__getInfoResponse *result_soap);
