...
SOAP_FMAC3 ns__Usuario * SOAP_FMAC4 soap_in_ns__Usuario(struct soap*, const char*, ns__Usuario *, const char*);
SOAP_FMAC1 ns__Usuario * SOAP_FMAC2 soap_instantiate_ns__Usuario(struct soap*, int, const char*, const char*, size_t*);

inline ns__Usuario * soap_new_ns__Usuario(struct soap *soap, int n = -1)
{
	return soap_instantiate_ns__Usuario(soap, n, NULL, NULL, NULL);
}
...
inline int soap_write_ns__Usuario(struct soap *soap, ns__Usuario const*p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns:Usuario", p->soap_type() == SOAP_TYPE_ns__Usuario ? "" : NULL) || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
SOAP_FMAC3 ns__Usuario * SOAP_FMAC4 soap_get_ns__Usuario(struct soap*, ns__Usuario *, const char*, const char*);

inline int soap_read_ns__Usuario(struct soap *soap, ns__Usuario *p)
{
	if (p)
	{	p->soap_default(soap);
		if (soap_begin_recv(soap) || soap_get_ns__Usuario(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
#ifndef SOAP_TYPE_PointerTons__Usuario_DEFINED
#define SOAP_TYPE_PointerTons__Usuario_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTons__Usuario(struct soap*, ns__Usuario *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTons__Usuario(struct soap*, const char *, int, ns__Usuario *const*, const char *);
