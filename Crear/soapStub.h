...
struct Input;	/* CrearAlumno.h:5 */
struct ns__getInfoResponse;	/* CrearAlumno.h:9 */
struct ns__getInfo;	/* CrearAlumno.h:13 */
...
struct ns__getInfo {
      public:
        /** Optional element 'insert' of XSD type 'Input' */
        struct Input *insert;
      public:
...
\******************************************************************************/
    ...
    SOAP_FMAC5 int SOAP_FMAC6 ns__getInfo(struct soap*, struct Input *insert, struct ns__getInfoResponse *result_soap);
