...
struct Input;	/* FriendRequest.h:5 */
struct ns__getInfoResponse;	/* FriendRequest.h:9 */
struct ns__getInfo;	/* FriendRequest.h:12 */
...
struct Input {
      public:
        /** Required element 'Id-sender' of XSD type 'xsd:int' */
        int Id_sender;
        /** Required element 'Id-receiver' of XSD type 'xsd:int' */
        int Id_receiver;
      public:
...
#define SOAP_TYPE_ns__getInfo (12)
